...
set LIB_PATH "/data/cc03group4/vlsi/Assignment/synthesis/Genus_BoundFlasher/LIB"    ;# <-- UPDATE THIS
set LIB_NAME "slow.lib"        ;# <-- UPDATE THIS
set LEF_FILE "/data/cc03group4/vlsi/Assignment/synthesis/Genus_BoundFlasher/LEF/gsclib045_tech.lef /data/cc03group4/vlsi/Assignment/synthesis/Genus_BoundFlasher/LEF/gsclib045_macro.lef"    ;# <-- UPDATE THIS
